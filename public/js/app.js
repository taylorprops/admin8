...
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js"); // Document Management


__webpack_require__(/*! ./doc_management/add_fields.js */ "./resources/js/doc_management/add_fields.js");

__webpack_require__(/*! ./doc_management/files.js */ "./resources/js/doc_management/files.js");

__webpack_require__(/*! ./doc_management/upload.js */ "./resources/js/doc_management/upload.js");
...
/***/ "./resources/js/doc_management/add_fields.js":
/*!***************************************************!*\
  !*** ./resources/js/doc_management/add_fields.js ***!
  \***************************************************/
/*! no static exports found */
...
$(document).on('dblclick', '.file-view-image', function (e) {
  ...
  var t = $('#active_field').val(); // only if a field has been selected

  if (t != '') {
    // get bounding box coordinates
    var rect = e.target.getBoundingClientRect(); // get target coordinates

    var x = parseInt(Math.round(e.clientX - rect.left));
    var y = parseInt(Math.round(e.clientY - rect.top)); // remove excess from field panel at top

    y = y - parseInt($('#field_textline_height').val()) + 3; // set w and h for next element created - always the same as last element added

    var w = parseInt($('#field_textline_width').val());
    var h = parseInt($('#field_textline_height').val()); // create unique id for field

    var id = Date.now();

    if (t == 'textline') {
      // hide all handles and buttons
      $('.focused').hide(); //create field and attach to container

      var field = field_text(h, w, x, y, id); // append new field
...
function set_field_textline_options(ele, h, w, x, y, id, rect, container) {
  ele.click(function () {
    ...
    // tried containment: $('#page_div_'+$('#active_field').val()), but not go
    handles: {
      'ne': '.ui-resizable-ne',
      'nw': '.ui-resizable-nw',
      'se': '.ui-resizable-se',
  ...
  $('.remove-field-textline').off('click').on('click', function () {
    ...
    if (remove_groupid != '') {
      var group = $('.c_' + remove_groupid); // hide add line option for all but last

      group.find('.field-textline-addline-container').hide();
      group.find('.field-textline-addline-container').last().show(); // see if other divs in a group and if just one remove group class
  ...
  $('.field-textline-addline').off('click').on('click', function () {
    ...
    $('.add-new-line').off('click').on('click', function () {
      ...
      y = y + h + 10;
      $('.text-line-div').removeClass('active'); // create new id for new field in group
      ...
      setTimeout(function () {
        ...
        set_hwxy(h, w, x, y, '', 'textline'); // assign group id to new field
...
function set_hwxy(h, w, x, y, groupid, type) {
  ...
  $(this).data('page', $('#active_page').val()); //var x_perc = ( 100 * parseFloat(x / parseFloat($(this).parent().width())) ) + "%" ;
...
/***/ "./resources/js/doc_management/files.js":
/*!**********************************************!*\
  !*** ./resources/js/doc_management/files.js ***!
  \**********************************************/
/*! no static exports found */
...
/***/ "./resources/js/doc_management/upload.js":
/*!***********************************************!*\
  !*** ./resources/js/doc_management/upload.js ***!
  \***********************************************/
/*! no static exports found */
  ...
  $('#upload_file_form').submit(function (e) {
    ...
    $.ajax({
      ...
      success: function success(data) {
        window.location = '/doc_management';
      }
    });
  });
});
...
__webpack_require__(/*! C:\wamp64\www\docs\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\wamp64\www\docs\resources\sass\app.scss */"./resources/sass/app.scss");
