<?php
    ...
    Route::get('/agents/doc_management/transactions/listings/get_details_header', 'Agents\DocManagement\Transactions\Listings\ListingDetailsController@get_details_header');
    ...
    Route::get('/agents/doc_management/transactions/listings/get_docs', 'Agents\DocManagement\Transactions\Listings\ListingDetailsController@get_docs');
    ...
    // listing page
    Route::get('/agents/doc_management/transactions/listings/listing_details/{Listing_ID}', 'Agents\DocManagement\Transactions\Listings\ListingDetailsController@listing');
