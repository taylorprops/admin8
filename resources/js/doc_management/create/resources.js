...
if (document.URL.match('/create/resources')) {
    ...
    $(document).ready(function () {
        ...
        $('.sortable').sortable({
            ...
            stop: function (event, ui) {
                ...
                axios.post('/doc_management/create/resources/reorder', formData, axios_options)
...
function added_item_html(resource_id, resource_type, resource_name, resource_state, resource_color, resource_association, resource_county_abbr) {
    let resource_html = ' \
    ...
    resource_html += ' \
                    <div class="col-1"> \
                        <a href="javascript: void(0)" class="save-edit-resource-button" data-resource-id="' + resource_id + '" data-resource-type="' + resource_type + '"><i class="fad fa-save text-primary fa-lg mt-3"></i></a> \
                    </div> \
                    <div class="col-1"> \
                        <a href="javascript: void(0)" class="close-edit-resource-button"><i class="fal fa-times text-danger fa-lg mt-3"></i></a> \
                    </div> \
                </div> \
            </form> \
        </div> \
...
function show_add_resource(ele) {
    ...
    reset_add_resource_div(add_resource_div, add_button, resource_input, resource_state_select, resource_input_color, resource_association_select, resource_county_abbr_input, cancel_button);
    ...
    save_button.off('click').on('click', function () {
        ...
        if (validate == 'yes') {
            ...
            axios.post('/doc_management/create/resources/add', formData, axios_options)
                .then(function (response) {
                    cancel_button.trigger('click');
                    toastr['success']('Resource Added Successfully');
                    let resource_id = response.data;
                    let new_resource_html = added_item_html(resource_id, resource_type, resource_name, resource_state, resource_color, resource_association, resource_county_abbr);
...
function reset_add_resource_div(add_resource_div, add_button, resource_input, resource_state_select, resource_input_color, resource_association_select, resource_county_abbr_input, cancel_button) {
    add_resource_div.slideUp('fast');
    add_button.show();
    resource_input.val('').trigger('change');
    if (resource_state_select) {
...
function show_edit_resource(ele) {
    ...
    save.off('click').on('click', function () {
        ...
        save_edit_resource($(this), resource_input, resource_state_select, resource_input_color, resource_association_select, resource_county_abbr_input, list_group_item, resource_div, resource_type);

    });

    close.click(function () {

        reset_edit_resource_div(list_group_item, resource_div, resource_input, resource_state_select, resource_association_select, resource_input_color, resource_county_abbr_input);

    });

}

function reset_edit_resource_div(list_group_item, resource_div, resource_input, resource_state_select, resource_association_select, resource_input_color, resource_county_abbr_input) {
...
function save_edit_resource(ele, resource_input, resource_state_select, resource_input_color, resource_association_select, resource_county_abbr_input, list_group_item, resource_div, resource_type) {
    ...
    if (validate == 'yes') {
        ...
        axios.post('/doc_management/create/resources/edit', formData, axios_options)
            .then(function (response) {
...
function delete_resource(ele) {
    ...
    axios.post('/doc_management/create/resources/delete', formData, axios_options)
        .then(function (response) {
