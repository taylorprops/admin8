    ...
    <div class="row">
        <div class="col-12">
            ...
            <form id="details_form" autocomplete="off">
                ...
                <div class="row">
                    <div class="col-12">
                        <a href="javascript: void(0);" class="btn btn-sm btn-primary" id="import_property_address_button" data-street="{{ $referral -> FullStreetAddress }}" data-city="{{ $referral -> City }}" data-state="{{ $referral -> StateOrProvince }}" data-zip="{{ $referral -> PostalCode }}">Use Property Address</a>
                    </div>
                </div>
