...
<div class="container-fluid page-add-listing mx-auto">
    <div class="row">
        <div class="col-12">
            ...
            <div id="address_search_container" class="address-container back-to-address-search collapse show">
                ...
                <div class="address-search-continue-div text-center my-4 hidden">
                    <a href="#mls_match_container" class="btn btn-primary btn-lg" id="address_search_continue" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="#mls_match_container">Continue <i class="fad fa-chevron-double-right ml-3"></i></a>
                </div>
            ...
            <div id="address_enter_container" class="address-container collapse">
                ...
                <form id="enter_address_form">
                    ...
                    <div class="address-enter-continue-div text-center my-4">
                        <button id="address_enter_continue" class="btn btn-primary btn-lg" type="button" data-toggle="collapse" data-target="#mls_match_container" aria-expanded="false" aria-controls="mls_match_container" disabled>
            ...
            <div id="mls_match_container" class="mls-match-container back-to-address-search collapse">
                <a class="btn-floating btn-primary" data-toggle="collapse" href=".back-to-address-search" role="button" aria-expanded="false" aria-controls="address_search_container mls_match_container"><i class="fad fa-chevron-double-left"></i></a>
            </div>
        </div>
    </div>
</div>
