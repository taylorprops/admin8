                        ...
                        <div class="mt-5">
                            <div class="row">
                                <div class="col-sm-9 col-lg-10">
                                    <div class="h5-responsive text-primary">Enter Property Street Address</div>
                                    <input type="text" class="w-100" id="address_search_street" placeholder="">
                                </div>
                                <div class="col-sm-3 col-lg-2">
                                    <div class="h5-responsive text-primary">Unit</div>
                                    <input type="text" class="w-100" id="address_search_unit" placeholder="">
                                </div>
                            </div>
                        </div>
            ...
            <div id="mls_match_container" class="property-container collapse mx-auto">
                ...
                <div class="property-results-container hidden">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="h2-responsive text-primary mb-3 text-center">We found the following matching property</div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="border border-primary text-primary p-3 z-depth-2">
                                    <div class="row">
                                        <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="mt-4 text-center w-100">
                                    ...
                                    <br>
                                    <a class="btn btn-sm btn-danger mt-5" data-toggle="collapse" href=".property-container" role="button" aria-expanded="false" aria-controls="#mls_match_container #address_container">This is not my listing</a>
                                </div>
                            </div>
                        </div>
                    </div>
