...
if($field_type == 'radio' || $field_type == 'checkbox') {
    ...
    $data_div_styles = $data_div_styles.' letter-spacing:0.06em;';
}
                    ...
                    <div class="container form-div">
                        ...
                        @if($field_type == 'textline')
                            ...
                            <div class="row p-3 mb-1">
                                <div class="col-12">
                                    <div class="my-3">
                                        <textarea class="custom-form-element form-textarea fillable-field-input {{ $textline_class }}" id="{{ $input_id }}" data-label="{{ $field -> field_name_display }}" rows="3" data-default-value="{{ $value }}" data-common-name="{{ $common_name }}">{{  $value }}</textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        @elseif($field_type == 'name' || $field_type == 'address')
                            ...
                            <div class="row p-3 mb-1">
                                ...
                                @foreach($field_inputs_system as $input_system)

                                    @if($field -> field_id == $input_system -> field_id)
                        ...
                        @elseif($field_type == 'number')
                            ...
                            <div class="row p-3 border border-secondary mb-1">
                                <div class="col-12">
                                    ...
                                    <div class="my-1">
                                        <input type="text" class="custom-form-element form-input numbers-only fillable-field-input" id="{{ $input_id }}" data-label="{{ $field -> field_name_display }}" value="{{ $value }}" data-common-name="{{ $common_name }}">
                                    </div>
                                </div>
                            </div>
