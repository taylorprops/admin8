<div class="container p-1 p-sm-4">
    <div class="row">
        <div class="col-12">
            ...
            <div class="h4-responsive text-primary ml-3"><i class="fad fa-file-signature mr-2 mb-3"></i> Accepted Contracts</div>
                        ...
                        <div class="contract-div @if($status != '') bg-primary @else bg-default @endif p-3 mb-2 m-sm-2 h-100 z-depth-1 {{ $status }}">
                            <div class="d-flex justify-content-start align-items-center">
                                ...
                                <div>
                                    ...
                                    <div class="h4-responsive text-white">${{ number_format($contract -> ContractPrice) }}</div>
                                </div>
                            </div>
                            <hr class="bg-white">
                            <div class="row text-white">
                                ...
                                <div class="col-5 text-right">Settle Date</div>
                                ...
                                <div class="col-5 text-right">Buyer's Agent</div>
                                ...
                                <div class="col-5 text-right">Buyer</div>
