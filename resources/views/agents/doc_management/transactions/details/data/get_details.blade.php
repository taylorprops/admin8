                        ...
                        <div class="transaction-details-div mt-4 mb-2 z-depth-1">
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-3 col-xl-2">
                                    <input type="text" class="custom-form-element form-input required" data-label="Street Number" name="StreetNumber" id="StreetNumber" value="{{ $property -> StreetNumber += 0 }}">
                                </div>
                                <div class="col-12 col-lg-6 col-xl-4">
                                    <input type="text" class="custom-form-element form-input required" data-label="Street Name" name="StreetName" id="StreetName" value="{{ $property -> StreetName }}">
                                </div>
                                <div class="col-12 col-lg-3 col-xl-2">
                                ...
                                <div class="col-12 col-lg-3 col-xl-2">
                                    <input type="text" class="custom-form-element form-input" data-label="Unit" name="UnitNumber" id="UnitNumber" value="{{ $property -> UnitNumber }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-lg-8 col-xl-4">
                                    <input type="text" class="custom-form-element form-input required" data-label="City" name="City" id="City" value="{{ $property -> City }}">
                                </div>
                                <div class="col-12 col-lg-4 col-xl-2">
                                    <select class="custom-form-element form-select form-select-no-cancel required" data-label="State" name="StateOrProvince" id="StateOrProvince">
                                        ...
                                        <option value="{{ $state }}" @if($property -> StateOrProvince == $state) selected @endif>{{ $state }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-12 col-lg-4 col-xl-2">
                                    <input type="text" class="custom-form-element form-input required" data-label="Postal Code" name="PostalCode" id="PostalCode" value="{{ $property -> PostalCode }}">
                                </div>
                                <div class="col-12 col-lg-8 col-xl-4">
                                    <div class="row">
