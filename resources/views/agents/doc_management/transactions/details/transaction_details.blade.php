                ...
                <form id="edit_check_out_form">
                    ...
                    <div class="p-3">
                        ...
                        <div class="row mb-3 mt-3">
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <select class="custom-form-element form-select form-select-no-search form-select-no-cancel" id="edit_check_out_delivery_method" name="edit_check_out_delivery_method" data-label="Select Delivery Method">
                                    <option value=""></option>
                ...
                <form id="add_check_out_form" enctype="multipart/form-data">
                    ...
                    <div class="p-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <select class="custom-form-element form-select form-select-no-search form-select-no-cancel"id="check_out_delivery_method" name="check_out_delivery_method" data-label="Select Delivery Method">
                                    <option value=""></option>
                                    <option value="pickup">Picking Up</option>
                                    <option value="mail">Mailing To</option>
                                    <option value="fedex">FedEx</option>
