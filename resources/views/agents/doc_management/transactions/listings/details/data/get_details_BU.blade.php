    ...
    <div class="row">
        <div class="col-12">
            <form id="listing_details_form">
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-xl-4 px-0 px-sm-3">
                        <div class="listing-details-div mb-2 mt-2 z-depth-1 pb-5">
                    ...
                    <div class="col-12 col-md-6 col-xl-8 px-0 px-sm-3">

                        <div class="listing-details-div mb-1 mt-2 z-depth-1">
                            <div class="h5 m-2 mb-4 text-default">
