            ...
            <div class="row members-list-group">
                <div class="col-12 col-md-4">
                    ...
                    " id="members_tab" role="tablist">
                        ...
                        <a class="list-group-item list-group-item-action list-group-item-member @if($loop -> first) active @endif" id="member_{{ $member -> id }}_item" data-toggle="list" href="#member_{{ $member -> id }}_div" role="tab"><span class="font-weight-bold">{{ $resource_items -> GetResourceName($member -> member_type_id) }}</span> - @if($member -> first_name) {{ $member -> first_name . ' ' . $member -> last_name }} @else {{ $member -> company }} @endif</a>
                        @endforeach
                    </div>
                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            <select class="custom-form-element form-select form-select-no-search form-select-no-cancel member-type-id required" data-label="Member Role">
                                                <option value=""></option>
