<div class="row animated fadeIn">
    ...
    <div class="col-12">
        ...
        <div class="review-image-container">
            ...
            <div class="review-image-div mx-auto">
                ...
                @foreach($checklist_item_documents as $document)
                    ...
                    <div class="checklist-item-docs-div bg-white my-1 p-1 small">
        ...
        <div class="document-options-div w-100">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="review-options px-5 {{ $bg_color }}">
                    ...
                    <div class="@if($item_review_status == 'not_reviewed') d-flex @else d-none @endif justify-content-around align-items-center mb-1 item-not-reviewed w-100 h-100 p-1">
                        <button type="button" class="btn btn-success accept-checklist-item-button mr-5"><i class="fa fa-check mr-2"></i> Accept</button>
                ...
                <div class="mr-5 mt-2">
                    <div class="d-flex justify-content-center align-items-center mt-2">
                        <span class="font-weight-bold text-primary mr-2"><i class="fa fa-minus-circle"></i></span>
                        <form class="range-field ml-0 mt-2 mr-0 mb-0">
                            <input class="border-0 m-0" id="zoom" type="range" min="50" max="150" value="85" />
                        </form>
                        <span class="font-weight-bold text-primary ml-2"><i class="fa fa-plus-circle"></i></span>
                    </div>
                </div>
