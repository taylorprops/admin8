            ...
            <div class="col-12 options-holder">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <a href="/doc_management/create/add_fields/{{ $file -> file_id }}" class="btn btn-sm btn-primary"><i class="fal fa-plus mr-2"></i> Add/Edit Fields</a>
                        @else
                        <a href="javascript: void(0" class="material-tooltip-main mr-5" data-toggle="tooltip" title="This form can no longer be edited or deleted"><span class="chip green text-white"><i class="fad fa-check mr-2"></i> Published</span></a>
                        @endif
                    </div>
                    <div>
