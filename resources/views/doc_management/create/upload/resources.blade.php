                        ...
                        <div class="container add-resource-div bg-white p-3 z-depth-2">
                            ...
                            <form>
                                <div class="row">
                                    ...
                                    @endif
                                    <div class="col">
                                        <a href="javascript:void(0)" class="btn btn-success add-resource-save-button"><i class="fad fa-save mr-2"></i> Save</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                                ...
                                <div class="resource-div-edit container-fluid">
                                    <form>
                                        <div class="row  py-3">
                                            ...
                                            @endif
                                            <div class="col-1">
                                                <a href="javascript: void(0)" class="save-edit-resource-button" data-resource-id="{{ $resources_item -> resource_id }}"  data-resource-type="{{ $resources_item -> resource_type }}"><i class="fad fa-check text-success fa-2x mt-2"></i></a>
                                            </div>
                                            <div class="col-1">
                                                <a href="javascript: void(0)" class="close-edit-resource-button"><i class="fad fa-times text-danger fa-2x mt-2"></i></a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
