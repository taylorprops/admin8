                                ...
                                <table class="table table-hover table-sm" id="add_to_checklists_table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="checklist-items-tr filter-active @if($in_checklist) bg-blue-light @endif"
                                            ...
                                            <td><input type="number" min="1" max="{{ $items_count + 1 }}" class="custom-form-element form-input numbers-only checklist-order" data-label="Order" style="width: 100px" value="{{ $order }}"></td>
